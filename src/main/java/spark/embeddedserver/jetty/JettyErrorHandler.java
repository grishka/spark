...
public class JettyErrorHandler extends ErrorHandler{
    ...
    @Override
    protected void generateAcceptableResponse(org.eclipse.jetty.server.Request baseRequest, HttpServletRequest servletRequest, HttpServletResponse servletResponse, int code, String message, String contentType) throws IOException{
